...
class AIService:
    ...
    def _build_prompt(
        ...
        return (
            ...
            "   - If it's a QUESTION (e.g., 'Analysis', 'Batao', 'Explain'): Use 'analyze_workbook' and provide a detailed verbal answer in 'explanation'.\n"
            "   - If it's an ACTION (e.g., 'Apply', 'Do', 'Fix', 'Insert'): Choose the appropriate action(s). Use 'batch' if >1 step is needed.\n\n"
